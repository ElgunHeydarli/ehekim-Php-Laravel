    ...
    <div class="content-wrapper pb-0">
        <div class="page-header">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('galleries') }}">Qalareya</a></li>
                </ol>
            </nav>
        </div>
        <form method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" value="{{ $gallery->title }}" name="title" class="form-control" placeholder="Başlıq">
                @error('title')
            ...
            <div class="form-group">
                ...
                <div class="upload-box">
                    <div class="image-box">
                        <img src="{{ asset('uploads/galleries/' . $gallery->image) }}" width="150" alt="">
                    </div>
                </div>
            </div>
