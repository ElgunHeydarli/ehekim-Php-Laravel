    ...
    <div class="content-wrapper pb-0">
        <div class="page-header">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('companies') }}">Kompaniyalar</a></li>
                </ol>
            </nav>
        </div>
        <form method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" value="{{ $company->title }}" name="title" class="form-control" placeholder="Başlıq">
                @error('title')
            ...
            <div class="form-group">
                ...
                <div class="upload-box">
                    <div class="image-box">
                        <img src="{{ asset('uploads/companies/' . $company->image) }}" width="150" alt="">
                    </div>
                </div>
            </div>
            <div class="form-group">
                <label>Kataloq</label>
                <input type="file" name="catalog" accept=".png,.jpg" class="file-upload-default" />
                <div class="input-group col-xs-12">
                    <input type="text" class="form-control file-upload-info" disabled placeholder="Şəkil yüklə" />
                    <span class="input-group-append">
                        <button class="file-upload-browse btn btn-primary" type="button"> Şəkil yüklə </button>
