    ...
    <div class="content-wrapper pb-0">
        ...
        <form method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" value="{{ $tag->name }}" name="name" class="form-control" placeholder="Başlıq">
                @error('name')
            ...
            <div class="form-group">
                ...
                <textarea name="description" class="form-control" id="editor">{{ $tag->description }}</textarea>
                @error('description')
                    <span class="text-danger mt-2">{{ $message }}</span>
                @enderror
            </div>
