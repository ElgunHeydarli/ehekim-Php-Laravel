    ...
    <div class="content-wrapper pb-0">
        <div class="page-header">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('brands') }}">Brendlər</a></li>
                </ol>
            </nav>
        </div>
        <form method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="file" name="multiple[]" accept=".png,.jpg" multiple class="file-upload-default" />
                ...
                <div class="upload-box">
                    @foreach ($brand->images as $image)
                        <div class="image-box">
                            <img src="{{ asset('uploads/brands/' . $image) }}" width="150" alt="">
